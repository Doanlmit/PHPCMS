<section class="itq-tab">
    ...
    <ul>
        ...
        <li class="active"><a href="backend/article/additem" title="Thêm bài viết">Thêm bài viết</a></li>
    </ul>
</section>
           ...
           <header>Thông tin chung</header>
            ...
            <section class="block">
                ...
                <label class="item">
                    ...
                    <textarea type="text" id="editor" name="data[content]" value="<?php echo common_valuepost(isset($_post['content']) ? $_post['content'] : '') ?>" class="mceEditor"></textarea> 
                </label>
                    ...
                    <section class="container">                     
                        ...
                        <label class="item">
                            ...
                            <p class="label">Meta Descriptions:</p>
                                <textarea type="text" name="data[meta_descriptions]" value="<?php echo common_valuepost(isset($_post['meta_descriptions']) ? $_post['meta_descriptions'] : '') ?>" class="txtText"></textarea> 
                        </label>
